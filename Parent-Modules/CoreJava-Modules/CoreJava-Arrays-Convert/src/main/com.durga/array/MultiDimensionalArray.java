...
public class MultiDimensionalArray {
    ...
    public void initialize2DArray(int[][] multiDimensionalArray) {
        for (int[] array : multiDimensionalArray) {
            Arrays.fill(array, 7);
        }
    }

    public void printElements(int[][] multiDimensionalArray) {
        for (int index = 0; index < multiDimensionalArray.length; index++) {
            System.out.println(Arrays.toString(multiDimensionalArray[index]));
        }
    }

    public int[] getElementAtGivenIndex(int[][] multiDimensionalArray, int index) {
        return multiDimensionalArray[index];
    }

    public int[] findLengthOfElements(int[][] multiDimensionalArray) {
    ...
    public int[][] copy2DArray(int[][] arrayOfArrays) {
