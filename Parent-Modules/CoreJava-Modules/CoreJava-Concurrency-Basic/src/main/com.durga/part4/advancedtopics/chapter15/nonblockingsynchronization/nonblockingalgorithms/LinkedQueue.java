package part4.advancedtopics.chapter15.nonblockingsynchronization.nonblockingalgorithms;
...
public class LinkedQueue <E> {
    ...
    public boolean put(final E item) {
        ...
        while (true) {
            final Node<E> curTail = this.tail.get();
            final Node<E> tailNext = curTail.next.get();
