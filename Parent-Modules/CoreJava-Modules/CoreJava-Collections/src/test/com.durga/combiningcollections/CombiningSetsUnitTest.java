...
public class CombiningSetsUnitTest {
	private static final Set<Object> first = new HashSet<Object>(Arrays.asList("One", "Two", "Three"));

	private static final Set<Object> second = new HashSet<Object>(Arrays.asList("Four", "Five", "Six"));
