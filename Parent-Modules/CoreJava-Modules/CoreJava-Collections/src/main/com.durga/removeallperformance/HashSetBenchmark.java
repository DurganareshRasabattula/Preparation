...
import containsperformance.Employee;
...
public class HashSetBenchmark {
    ...
    public static class MyState {
        private final Set<Employee> employeeSet1 = new HashSet<>();
        private final List<Employee> employeeList1 = new ArrayList<>();
        private final Set<Employee> employeeSet2 = new HashSet<>();
        private final List<Employee> employeeList2 = new ArrayList<>();
        private final Set<Employee> employeeSet3 = new HashSet<>();
        private final Set<Employee> employeeSet4 = new HashSet<>();

        private final long set1Size = 60000;
        private final long list1Size = 50000;
        private final long set2Size = 50000;
        private final long list2Size = 60000;
        private final long set3Size = 50000;
        private final long set4Size = 60000;
